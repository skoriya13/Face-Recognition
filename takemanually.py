    ...
    def fill_attendance():
        ...
        if subb == "":
            ...
            def create_csv():
                df = pd.DataFrame(d)
                csv_name = (
                    "E:\\Python Program\\Attendance-Management-system-using-face-recognition-master\\Attendance(Manually)\\"
                    + subb
                    + "_"
                    + Date
                    + "_"
            ...
            def attf():
                ...
                subprocess.Popen(
                    r'explorer /select,"E:/Python Program/Attendance-Management-system-using-face-recognition-master/Attendance(Manually)"'
                )
